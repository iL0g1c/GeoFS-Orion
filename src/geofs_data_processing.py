...
from tools import multiplayer_api, map_api, mongodb_batch_processor
...
class DataCollectionLayer():
    def __init__(self):
        ...
        # sets up APIs
        self.multiplayer_api = multiplayer_api.MultiplayerAPI(self.SESSION_ID, self.ACCOUNT_ID)
        self.mapAPI = map_api.MapAPI()
    ...
    def setup_batch_processors(self, db):
        self.batch_processors = {
            "forces": mongodb_batch_processor(db["forces"]),
            "player_locations": mongodb_batch_processor(db["player_locations"]),
            "chat_messages": mongodb_batch_processor(db["chat_messages"]),
            "users": mongodb_batch_processor(db["users"])
        }
